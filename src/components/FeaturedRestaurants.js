...
const FeaturedRestaurants = () => {
  ...
  return (
    <section className="py-28 px-4">
      <div className="max-w-7xl mx-auto h-[1500px] lg:h-[1000px] xl:h-[550px]">
        <div className="w-full h-full flex flex-col xl:flex-row justify-between items-start gap-14 xl:gap-0">
          <div className="w-full xl:w-[30%] h-full bg-green-600 flex flex-col justify-center items-center gap-16 p-10 rounded-sm">
          ...
          <div className="w-full xl:w-[60%] h-full flex flex-col md:flex-row justify-center items-center gap-5">
