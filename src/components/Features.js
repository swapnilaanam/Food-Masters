    ...
    return (
        <section className="py-28 px-4">
            <div className="max-w-7xl mx-auto bg-orange-100 border-t-2 border-gray-50 shadow-xl">
                <h2 className="text-center text-4xl font-medium tracking-wide mt-16 mb-5">How We Work</h2>
                <div className="flex flex-col lg:flex-row justify-between items-center gap-14 rounded p-10">
                    ...
                    <div className="hidden xl:block w-20 h-20">
